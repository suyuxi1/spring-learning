...
public class JueJinSpider {
    ...
    public static List<Topic> getTopics() {
        ...
        //目标地址
        String url = "https://short-msg-ms.juejin.im/v1/topicList?uid=5e1b45fa5188254dc67a7e42&device_id=1585288171111&token=eyJhY2Nlc3NfdG9rZW4iOiJERzJ6SzJkUFBvaDFRd0tyIiwicmVmcmVzaF90b2tlbiI6IjJmdVRkWHY2YmpIV1VFeWgiLCJ0b2tlbl90eXBlIjoibWFjIiwiZXhwaXJlX2luIjoyNTkyMDAwfQ%3D%3D&src=web&sortType=hot&page=0&pageSize=100";
        //创建httpclient对象
